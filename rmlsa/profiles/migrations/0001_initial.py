    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(default=None, blank=True,
                 upload_to='user_images/profiles/thumbnails', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver', models.ForeignKey(
                    to='profiles.Driver', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='profile',
            name='picture',
            field=models.ForeignKey(default=None, to='profiles.ProfileImage',
        ...
        migrations.AddField(
            model_name='driver',
            name='sponsor',
            field=models.ForeignKey(default=None, to='profiles.Sponsor',
                                    on_delete=django.db.models.deletion.SET_NULL, blank=True, null=True),
            preserve_default=True,
        ),
    ]
