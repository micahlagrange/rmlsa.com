<?php
/**
* @version 0.8.9 $Id: germani.php 227 2007-06-22 13:08:22Z schlu $
* @package Eventlist
...
DEFINE("_EVENTS_IMAGEUPLNOGD","GD-Bibliothek nicht verf&uuml;gbar! Deaktiviere bitte die Thumbnail Erzeugung in den Einstellungen.");
...
DEFINE("_ADMIN_EVENTS_IMAGEGDVERSWARN","Achtung: Eventlist ben&ouml;tigt f&uuml;r das erstellen von Thumbnails die GD-Bibliothek ab Version 2. Sollte auf Deinem Server keine GD-Bibliothek, oder noch in Version 1 installiert sein, deaktiviere bitte die Thumbnail Erzeugung in den Einstellungen.");
...
DEFINE("_ADMIN_EVENTS_DESCR_INTRO","Beschreibe hier den Event");
...
DEFINE("_ADMIN_EVENTS_DESCR_INTRO_LO","Beschreibe hier die Location");
...
DEFINE("_ADMIN_EVENTS_SAVEADRESS_LO","FEHLER: Es ist min. eine der folgenden Optionen aktiviert: link zu map24 anzeigen, Adresse anzeigen. Deaktiviere diese Optionen, wenn du diese Felder nicht ausf&uuml;llen m&ouml;chtest.");
...
//Frontend deliver
DEFINE("_ADMIN_EVENTS_DELIVNAME","Dein Name:");
DEFINE("_ADMIN_EVENTS_DELIVNAME_DESC","Bitte gib hier Deinen Namen ein");
DEFINE("_ADMIN_EVENTS_DELIVMAIL","Deine Emailadresse:");
DEFINE("_ADMIN_EVENTS_DELIVMAIL_DESC","Bitte gib hier Deine E-Mail Adresse an");
...
DEFINE("_ADMIN_EVENTS_SETT_SHOWLOC","Veranstaltungsort/Location anzeigen:");
...
DEFINE("_ADMIN_EVENTS_SETT_NEWDEL_DESC","Duerfen Events &uuml;ber das Frontend eingeliefert werden und ab welchem User Rang?");
...
DEFINE("_ADMIN_EVENTS_SETT_GDDISABLE_DESC","Sollte auf Deinem Server keine GD-Bibliothek, oder noch in Version 1 installiert sein, deaktiviere bitte die Thumbnailerzeugung.");
...
DEFINE("_ADMIN_EVENTS_SETT_COMM_SOL_DESC","W&auml;hle hier deine Community L&ouml;sung aus. Community Builder von Joomlapolis.com oder Community Builder Enhanced from www.kolloczek.com"); //changed in 0.8.3
...
DEFINE("_ADMIN_EVENTS_SETT_COMM_OPTION_DESC","W&auml;hle hier die Form der Integration. Event List unterst&uuml;tzt die Anzeige des Avatar und das erzeugen von Links zum Profil der zu einem Event registrierten Benutzer");
DEFINE("_ADMIN_EVENTS_SETT_HEADREG3","Achtung");
DEFINE("_ADMIN_EVENTS_SETT_COMM_NOTES","Event List unterst&uuml;tzt AKReservations wenn detailiertere/ausf&uuml;hrlichere Registrierungen erforderlich sind. Platziere dazu den mambot trigger von AKReservations in die Eventbeschreibung des entsprechenden Events. Link: ");
...
DEFINE("_ADMIN_EVENTS_SETT_GD_VERSION_ONE","GD Version ist 1. Deaktiviere bitte die Thumbnail Erzeugung.");
...
DEFINE("_EVENTS_REGISTRA_ALLRE","Du hast Dich bereits zu diesem Event angemeldet.");
DEFINE("_EVENTS_REGISTRA_LOGIN","Du musst dich auf der Seite anmelden um dich an Events registrieren zu k&ouml;nnen.");
...
DEFINE("_EVENTS_REGISTRA_SUCCESS","Du hast Dich erfolgreich zu diesem Event angemeldet.");
DEFINE("_EVENTS_REGISTRA_UNREG","Von Event abmelden:");
DEFINE("_EVENTS_REGISTRA_BUTTON_UNREG","Abmelden");
DEFINE("_EVENTS_REGISTER_DEL","Du hast Dich erfolgreich von diesem Event abgemeldet.");
...
DEFINE("_ADMIN_EVENTS_INFOBUTTON_ERROR_MSG", "Du hast die Einstellung gew&auml;hlt durch den infoicon auf die Details zu linken. Wenn Du das wirklich m&ouml;chtest, geben sie eine Breite f&uuml;r die Infospalte im Layout Tab an");
