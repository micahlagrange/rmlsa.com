<?php
/**
* @version 0.8.9 $Id: portuguesei.php 217 2007-06-18 14:49:07Z schlu $
* @package Eventlist
* @copyright (C) 2005 - 2007 Christoph Lukes
* @license http://www.gnu.org/copyleft/gpl.html GNU/GPL
* @Informal European Portuguese translation by Peter Romуo
*/
...
DEFINE("_EVENTS_DESCALERT","Desculpa, nehuma descriчуo disponэvel");
...
//images
DEFINE("_EVENTS_IMAGEEMPT","Selecciona uma imagem para transferir ,por favor");
DEFINE("_EVENTS_IMAGESIZEBIG","Tamanho do ficheiro estс errado");
DEFINE("_EVENTS_IMAGECHARACT","O nome do ficheiro sѓ pode conter caractщres alfanumщricos e nenhum espaчo em branco.");
DEFINE("_EVENTS_IMAGEEXIST","A imagem jс existe. Escolhe outro nome, por favor.");
...
DEFINE("_ADMIN_EVENTS_CHOOIMAGE","Escolhe a imagem:");
DEFINE("_ADMIN_EVENTS_IMAGEUPL","Escolhe a imagem para transferir:");
DEFINE("_EVENTS_IMAGEUPLSUCCESS","Transferъncia bem sucedida");
DEFINE("_EVENTS_IMAGEUPLNOGD","GD-Library nуo disponэvel! Desactiva a criaчуo de imagens miniatura, por favor.");
...
DEFINE("_ADMIN_EVENTS_IMAGEGDVERSWARN","Nota: O Eventlist requer a versуo 2 ou posterior do GD-Library para a criaчуo de miniaturas. Se nуo tiveres suporte GD ou ainda estejas a utilizar a versуo 1 desactiva a criaчуo de miniaturas.");
...
DEFINE("_ADMIN_EVENTS_DELFORMT","ERRO: Hora tem o formato errado ou entуo activaste a visualizaчуo de hora no espaчo pњblico. Neste caso deverсs preencher este campo");
DEFINE("_ADMIN_EVENTS_EMPTY","ERRO: primeiro adiciona a local");
...
DEFINE("_ADMIN_EVENTS_NO_LOC","ERRO: selecciona local ou adiciona aqui um local primeiro. Posteriormente poderсs adicionar eventos");		//changed in 0.8.3
...
DEFINE("_ADMIN_EVENTS_SEL_CAT","Selecciona categoria");
DEFINE("_ADMIN_EVENTS_SEL_LOC","Selecciona local");
DEFINE("_ADMIN_EVENTS_CATEMPTY","ERROR: Selecciona a categoria ou adiciona uma categoria primeiro. Posteriormente poderсs adicionar eventos");		//changed in 0.8.3
...
DEFINE("_ADMIN_EVENTS_REGISTRA","Activa registos:");
...
DEFINE("_ADMIN_EVENTS_DEL_LO", "ERRO: existe no mэnimo um evento neste loacl");
DEFINE("_ADMIN_EVENTS_DELYES_LO", " Localizaчуo(ѕes) apagada(s)");
DEFINE("_ADMIN_EVENTS_SAVECLUB_LO","ERRO: adiciona Local");
DEFINE("_ADMIN_EVENTS_SAVEHOMEP_LO","ERROR: adiciona pсgina internet");
DEFINE("_ADMIN_EVENTS_SAVETOWN_LO","ERROR: adiciona cidade");
...
DEFINE("_ADMIN_EVENTS_SAVEADRESS_LO","ERRO: Activaste uma das seguintes opчѕes: mostrar hiperligaчуo para map24, mostrar endereчo. Desactiva estas opчѕes se nуo quiseres preencher estes capos de endereчo");		//changed in 0.8.3
DEFINE("_ADMIN_EVENTS_OPTIONAL_LO","* sуo campos facultativos. Nota: Os campos de endereчo sѓ sуo facultativos caso tenhas desactivado a funcionalidade de map24!");
...
DEFINE("_ADMIN_EVENTS_DELIVNAME","O Teu Nome:");
DEFINE("_ADMIN_EVENTS_DELIVNAME_DESC","Adiciona o teu nome aqui, por favor");
DEFINE("_ADMIN_EVENTS_DELIVMAIL","O teu endereчo e-mail:");
DEFINE("_ADMIN_EVENTS_DELIVMAIL_DESC","Adiciona o teu endereчo de e-mail aqui, por favor");
DEFINE("_EVENTS_DELIVER","Entrega o Evento");
DEFINE("_EVENTS_VALIDATE","ERRO: Preenche todos os campos, por favor");
DEFINE("_ADMIN_EVENTS_DELIV_REDI","A entrega de eventos nуo estс permitida");		//changed in 0.8.3
DEFINE("_EVENTS_DELIVMAILBOD_1"," Recebeste um pedido do utilizador ");
...
DEFINE("_EVENTLIST_DELIVER","Submete novo evento");
...
DEFINE("_EVENTS_DEL_DATE_EMPT","Adiciona data, por favor!");
DEFINE("_EVENTS_DEL_TIME_EMPT","Adiciona hora, por favor!");
DEFINE("_EVENTS_DEL_TITEL_EMPT","Adiciona tэtulo, por favor!");
DEFINE("_EVENTS_DEL_CATEG_EMPT","Escolhe uma categoria, por favor!");
DEFINE("_EVENTS_DEL_LOCAT_EMPT","Escolhe um local, por favor!");
DEFINE("_EVENTS_DEL_TIME_FORM","ERRO: Hora tem o formato errado");

//Frontend deliver location
DEFINE("_EVENTLIST_DELIVER_LOC","Submete novo local");
DEFINE("_EVENTS_DELIVMAILLOCBOD_1"," Recebeste um pedido do utilizador ");		//changed in 0.8.3
...
DEFINE("_EVENTS_DELIVER_LOC","Submete local");
...
DEFINE("_EVENTS_DEL_LOC_STREET_EMPT","ERRO: Preenche a Rua, por favor!");
DEFINE("_EVENTS_DEL_LOC_PLZ_EMPT","ERRO: Preenche o Cѓd. Postal, por favor!");
DEFINE("_EVENTS_DEL_LOC_COUNTRY_EMPT","ERRO: Preenche o Cѓd. de Paэs, por favor!");
...
DEFINE("_ADMIN_EVENTS_SETT_MAPID","O teu identificador Map24:");
DEFINE("_ADMIN_EVENTS_SETT_MAPID_DESC","Deverсs registar-te no Map24 para obter um identificador.");
...
DEFINE("_ADMIN_EVENTS_SETT_SHOWTITEL_DESC","Mostrar o tэtulo doevento na pсgina inicial.");
...
DEFINE("_ADMIN_EVENTS_SETT_SHOWLINKMAP_DESC","Mostrar hiperligaчуo para o mapa na pсgina de detalhes. Nota: Necessitas introduzir o teu identificador map24 se escolheres este serviчo.");
...
DEFINE("_ADMIN_EVENTS_SETT_CNAME_DESC","Muda isto para o que tu quiseres.");
DEFINE("_ADMIN_EVENTS_SETT_TITELW","Largura da coluna de tэtulo em %:");
DEFINE("_ADMIN_EVENTS_SETT_TITELW_DESC","Largura da coluna de tэtulo (deixa em branco se o tiveres desactivado)");
...
DEFINE("_ADMIN_EVENTS_SETT_LOCA_DESC","Largura da coluna do local (deixa em branco se o tiveres desactivado)");
DEFINE("_ADMIN_EVENTS_SETT_CITYW","Largura da coluna da cidade em %:");
DEFINE("_ADMIN_EVENTS_SETT_CITYW_DESC","Largura da coluna da cidade (deixa em branco se o tiveres desactivado)");
...
DEFINE("_ADMIN_EVENTS_SETT_FORTIMENAME_DESC","Preenche &quot;h&quot; or &quot;Hora&quot; for example. Isto serс apresentado antes da hora no espaчo pњblico. Deixa em branco caso nуo precises.");		//changed in 0.8.3
DEFINE("_ADMIN_EVENTS_SETT_SHOWDETAILS","Mostrar hiperligaчуo para a pсgina de detalhe:");
DEFINE("_ADMIN_EVENTS_SETT_SHOWDETAILS_DESC","Mostrar hiperligaчуo para a pсgina de detalhes e onde? (Hiperligaчуo no tэtulo sѓ funcionarс se a mostrar tэtulo tenha sido atribuэdo sim, эcones sѓ aparecerуo caso tenhas definido a largura nos atributos de apresentaчуo)");		//changed in 0.8.3
...
DEFINE("_ADMIN_EVENTS_SETT_DATDESCLIMIT_DESC","Comprimento Mсx. do evento e da descriчуo de evento. Se o comprimento da descriчуo fєr demasido longo, a descriчуo serс truncada a nota [truncado] serс adicionada.");		//changed in 0.8.3
...
DEFINE("_ADMIN_EVENTS_SETT_CATW","Largura da caluna da categoria em %:");
DEFINE("_ADMIN_EVENTS_SETT_CATW_DESC","Largura da coluna da categoria (deixa em branco se a tiveres desactivado)");
DEFINE("_ADMIN_EVENTS_SETT_VIEW","Escolhe apresentaчуo por omissуo na pсgina inicial:");
...
DEFINE("_ADMIN_EVENTS_SETT_VIEW_DESC","Escolhe aqui a apresentaчуo por omissуo na pсgina inicial. 'Ver Listagem Simples' щ equivalente р apresentaчуo antiga.");
DEFINE("_ADMIN_EVENTS_SETT_NEWDELREC_DESC","Permitir acesso aos grupos filhos tambщm? Caso escolhas nуo, o acesso щ restrito ao grupo seleccionado. Nota: Administradores tъm sempre acesso.");
...
DEFINE("_ADMIN_EVENTS_SETT_GDDISABLE_DESC","Desactiva isto se o estado mostrar que a GD-Library nуo estс disponэvel ou caso sѓ tenhas a versуo 1.");
...
DEFINE("_ADMIN_EVENTS_SETT_IMAGECHMOD_DESC","Introduz aqui a permissѕes que desejas dar рs imagens. Exemplo 0740");		//changed in 0.8.3
...
DEFINE("_ADMIN_EVENTS_SETT_HEAD19","Colna Categoria");
DEFINE("_ADMIN_EVENTS_SETT_HEADREG1","Integraчуo");
DEFINE("_ADMIN_EVENTS_SETT_COMM_SOL","Escolhe a Soluчуo de Comunidade:");
DEFINE("_ADMIN_EVENTS_SETT_COMM_SOL1","Nуo utilizar nenhma");
DEFINE("_ADMIN_EVENTS_SETT_COMM_SOL2","CB / CBE");
DEFINE("_ADMIN_EVENTS_SETT_COMM_SOL_DESC","Escolhe a soluчуo de construчуo de comunidade que utilizas. Communitybuilder de Joomlapolis.com ou o Community Builder Enhanced de www.kolloczek.com");	//changed in 0.8.3
DEFINE("_ADMIN_EVENTS_SETT_HEADREG2","Opчѕes Soluчуo Comunidade");
DEFINE("_ADMIN_EVENTS_SETT_COMM_OPTION","Escolhe opчѕes de integraчуo:");
...
DEFINE("_ADMIN_EVENTS_SETT_COMM_OPTION_DESC","Escolhe o tipo de integraчуo. Eventlist suporta a apresentaчуo do Avatar e a geraчуo de hiperligaчѕes para o perfil do utilizador que se tenha registado num Evento");
DEFINE("_ADMIN_EVENTS_SETT_HEADREG3","Atenчуo");
DEFINE("_ADMIN_EVENTS_SETT_COMM_NOTES","Eventlist suporta o componente AKReservation caso necessites registos mais detalhados. Para tanto, basta simplesmente adicionar o gatilho mambot no campo da descriчуo do evento listado. Hiperligaчуo: ");
...
DEFINE("_ADMIN_EVENTS_SETT_WARNING","!! Verifica as opчѕes do teu mѓdulo! Activa isto sѓ no caso de o teres desactivado no teu mѓdulo. Nуo o utilizes duas vezes!!");		//changed in 0.8.3
DEFINE("_ADMIN_EVENTS_SETT_INFOBUT_WARNING","!! Apaga a largura, se utilizares uma hiperligaчуo para a pсgina de detalhes mediante o tэtulo ou se nуo utilizares nenhuma hiperligaчуo !!");
...
DEFINE("_ADMIN_CATEGORIES_NAME_EMPTY","ERRO: Preenche o nome da categoria, por favor!");
...
DEFINE("_EVENTS_REGISTRA_ALLRE","Jс estсs inscrito para este Evento.");	//changed in 0.8.3
DEFINE("_EVENTS_REGISTRA_LOGIN","Tens que te autenticar para te inscreveres neste Evento.");	//changed in 0.8.3
DEFINE("_EVENTS_REGISTRA_TOLATE","Jс щ demasiado tarde para te inscreveres neste evento.");	//changed in 0.8.3
DEFINE("_EVENTS_REGISTRA_REG","Vou estar presente neste Evento:");
DEFINE("_EVENTS_REGISTRA_BUTTON","Inscrever");
DEFINE("_EVENTS_REGISTRA_SUCCESS","Foste inscrito neste evento com sucesso.");		//changed in 0.8.3
DEFINE("_EVENTS_REGISTRA_UNREG","Anular inscriчуo neste evento:");
DEFINE("_EVENTS_REGISTRA_BUTTON_UNREG","Anular Inscriчуo");
DEFINE("_EVENTS_REGISTER_DEL","Jс nуo estсs inscrito neste evento");		//changed in 0.8.3
